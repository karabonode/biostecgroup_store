...
export default function Dev() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ── Hero ────────────────────────────────────────────────────────────────── */}
      <section className="relative overflow-hidden bg-slate-950 text-white py-16 sm:py-24 md:py-36">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65 }}>
              ...
              <h1 className="text-[2.4rem] sm:text-5xl md:text-6xl font-extrabold leading-[1.08] mb-5">
                We Build{' '}
                <span className="bg-clip-text text-transparent bg-linear-to-r from-blue-400 to-cyan-400">Websites</span>
                <br className="hidden sm:block" />{' '}&amp;{' '}
                <span className="bg-clip-text text-transparent bg-linear-to-r from-violet-400 to-pink-400">Web Apps</span>
                <br />That Work.
              </h1>
              <p className="text-base sm:text-lg text-slate-400 leading-relaxed mb-8 md:mb-10 max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a href="#get-started" className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-brand-primary text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20">
                  Start Your Project <ArrowRight className="w-4 h-4" />
                </a>
                <a href="#portfolio" className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-white/10 border border-white/15 text-white font-semibold rounded-xl hover:bg-white/20 transition-all backdrop-blur">
                  See Our Work
                </a>
              </div>
            </motion.div>
      ...
      <section className="py-14 md:py-20 bg-slate-50 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 md:mb-14">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">One team. Every digital need.</h2>
      ...
      <section id="portfolio" className="py-14 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 md:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">Live Sites We've Built</h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="bg-slate-100 border-b border-slate-200 px-3 py-2 flex items-center gap-2">
                    ...
                    <div className="flex-1 min-w-0 bg-white border border-slate-200 rounded-md px-2 py-1 text-[10px] text-slate-400 font-mono truncate flex items-center gap-1">
      ...
      <section className="py-12 md:py-16 bg-slate-950 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold">Built different. Delivered right.</h2>
          </motion.div>
      ...
      {/* ── Inquiry Form ─────────────────────────────────────────────────────────── */}
      <section id="get-started" className="py-14 md:py-20 bg-slate-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
            <p className="text-xs font-bold uppercase tracking-widest text-brand-primary mb-3">Get Started</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">Tell us about your project</h2>
          ...
          {status === 'sent' ? (
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-white rounded-2xl border border-emerald-100 p-8 sm:p-12 text-center shadow-sm">
            ...
            <motion.form initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} onSubmit={handleSubmit} className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 sm:p-8 space-y-6">
